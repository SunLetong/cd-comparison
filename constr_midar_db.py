...
def InsertNode2ASIntoDb_2(dirname):
    ...
    for root,dirs,files in os.walk('.'):
        for filename in files:
            ...
            #if filename != '2020-01_midar-iff.nodes.as':
                continue
...
def InsertIp2NodeIntoDb_2(dirname):
    ...
    for root,dirs,files in os.walk('.'):
        for filename in files:
                ...
                #continue
            if filename != '2016-09_midar-iff.nodes' and \
                filename != '2017-02_midar-iff.nodes' and \
                filename != '2019-04_midar-iff.nodes':
                continue
            print(filename)
...
if __name__ == '__main__':
    #ReadSomeContent()
    #InsertIp2NodeIntoDb_2('midar_data/')
